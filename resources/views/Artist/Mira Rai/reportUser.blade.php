                ...
                <div class="content">
                    <form action="#">
                        <div class="user-details">
                            ...
                            <div class="input-box">
                                <span class="details">Report to</span>
                                <input type="text" placeholder="Artist or User" required>
                            </div>
                            <div class="input-box">
                                <span class="details">Offender Name</span>
                                <input type="text" placeholder="Enter Name" required>
                            </div>
                            <div class="input-box1">
                                <span class="details">Reason for Report</span>
                                <input type="text" placeholder="Enter the reason to report a user and attach the proofs below if you have" required>
                            </div>

        ...
        <section class="section2" id="artist">
            ...
            <div class="section-head1 col-sm-12">
                ...
                <div class="section-head1 col-sm-12" id="expert">
                    ...
                    <h2 data-aos="fade-right"><span> My </span> Cart</h2>
                ...
                <div class="cart-container cart">
                    <table>
                        ...
                        <tr>
                            ...
                            <td> 
                                <div>
                                <p style="text-align: left;">{{ $item->painting_name }}</p>
                ...
                <div class="viewAll_btn" style="margin-right: 875px;">
                    <a href="orderNow">Checkout</a>
                </div>

                <div class="viewAll_btn" style="margin-right: 868px; margin-top: 30px;">
